...
var controlledPropUpdaterMap = {
  children: function children(thisArg, infoWindow, _children) {
    (0, _reactDom.unstable_renderSubtreeIntoContainer)(thisArg, _react.Children.only(_children), infoWindow.getContent());
  },
...
exports.default = (0, _flowRight3.default)(_react2.default.createClass, (0, _enhanceElement2.default)(getInstanceFromComponent, publicMethodMap, eventMap, controlledPropUpdaterMap))({
  ...
  componentDidMount: function componentDidMount() {
    ...
    controlledPropUpdaterMap.children(this, infoBox, this.props.children);
  },
